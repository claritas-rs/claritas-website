        ...
        <section id="features" class="py-24 relative">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-sm text-sidebar-muted max-w-2xl mx-auto uppercase tracking-wide">"The EPUB and PDF reader your CPU was waiting for."</p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="flat-card animate-on-scroll" style="animation-delay: 200ms;">
                        ...
                        <h3 class="text-sm font-bold mb-3 text-sidebar-title uppercase tracking-widest">"EPUB + PDF"</h3>
                        <p class="text-xs text-sidebar-muted leading-relaxed">"Read EPUB books and PDF documents in the same native app, with fast loading, search, and a library that stays local."</p>
                    </div>
